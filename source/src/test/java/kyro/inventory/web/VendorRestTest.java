...
public class VendorRestTest extends BaseRestTest {
    ...
    @Test
    public void testSearchVendorRest() throws Exception {

        BaseSearchParameters criteria = new BaseSearchParameters();
        criteria.page = 1;
        criteria.limit = 10;

        ObjectMapper objectMapper = new ObjectMapper();

        mockMvc.perform(post("/api/vendors/search").contentType(MediaType.APPLICATION_JSON_VALUE)
